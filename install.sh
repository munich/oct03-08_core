...
git clone "https://github.com/munich/oct03-08_core.git" "/home/bridgechain/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/munich/oct03-08_core.git'"
